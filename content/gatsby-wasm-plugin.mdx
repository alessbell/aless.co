...
import demo2 from '../public/images/gatsby-wasm-plugin/demo.jpg'
import bitmapFont from '../public/images/gatsby-wasm-plugin/bitmap.jpg'
import glitches from '../public/images/gatsby-wasm-plugin/glitches.jpg'
import twitterCard from '../public/images/gatsby-wasm-plugin/twitter-card.jpg'

export const meta = {
  author: 'Alessia Bellisario',
  date: '2020-01-06',
  title: 'Building a Gatsby Plugin with Wasm',
  description: 'Rust + Wasm + Node.js = 🦀🕸💚',
}
...
<Image
  src={demo2}
  alt="Proof of concept: generating my first Open Graph images for Twitter cards with Rust and WebAssembly"
/>
...
<Image
  src={twitterCard}
  alt="The resulting image for this post, using the same typeface and gradient that appear elsewhere on this website 😍"
/>
...
<Image
  src={glitches}
  alt="The image on the left is supposed to say '2019', while the image on the right is missing glyphs d, q and w"
/>
