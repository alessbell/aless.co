...
import resumePR from '../public/images/resume-as-code/resume-pr.jpg'

export const meta = {
  author: 'Alessia Bellisario',
  date: '2019-10-08',
  title: 'Resume as Code',
  description: 'Building a Resume with LaTeX + GitHub Actions',
}
...
<Image
  src={resumePR}
  alt="A screenshot of the GitHub Pull Requests UI showing the first PR created by my GitHub action: entitled 'Update resume to v1.1', this PR automatically updates my aless.co resume PDF with the one it downloaded from the latest automated release in another repository"
/>
...
I wound up with [~90 lines of bash](https://github.com/alessbell/aless.co/blob/main/commit-resume/entrypoint.sh) and successfully used [`jq`](https://stedolan.github.io/jq/) to process JSON for the first time. There was plenty of trial and error along the way, but once I plugged it all together, it Just Worked.
